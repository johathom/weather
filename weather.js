$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p>Currently it is "+ data.currently.summary + " and " + data.currently.temperature +" degrees. You can expect " + data.daily.summary + " Tomorrow will be " + data.daily.data[1].summary + " The following day we'll see " + data.daily.data[2].summary;
